...
import { computed, isReactive, isRef, ref, toRefs, watch } from '@vue/composition-api';
...
export default function useValidation(inputs, formData, checkDirty, registerAs, callbacks) {
	...
	keys.forEach((itemKey) => {
		if (isReactive(data)) {
			...
			if (
				(callbacks === null || callbacks === void 0 ? void 0 : callbacks.onInputValid) ||
				(callbacks === null || callbacks === void 0 ? void 0 : callbacks.onInputInvalid)
			) {
