...
import { computed, install, isReactive, isRef, ref, toRefs, watch } from 'vue-demi';
...
export default function useValidation(inputs, formData, checkDirty, registerAs, callbacks) {
    ...
    const v = useVuelidate(rules, formData, { $registerAs: registerAs });
    ...
    const isInputSilentlyInvalid = (key) => {
